...
export default function AgentOrdersPage() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted mb-8">Verify payment, track fulfillment, and confirm delivery.</p>
      {loading ? (
        ...
        <AgentOrdersList initialOrders={orders} currentActorName={session?.user?.name || "Agent"} />
      )}
    </div>
  );
}
