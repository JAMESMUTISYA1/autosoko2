...
export default function AdminSupportPage() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted mb-8">Platform-wide messages submitted through the public Contact Us form.</p>
      {loading ? <p className="text-sm text-muted">Loading...</p> : <ContactMessagesList initialMessages={messages} currentActorName={session?.user?.name || "Admin"} />}
    </div>
  );
}
